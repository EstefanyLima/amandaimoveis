...
<head>
<meta charset="UTF-8">
<title>Amanda Imóveis - Venda</title>
...
<div class="container mt-4" style="padding-top: 6%;">
  ...
  <ol class="breadcrumb mt-4">
    ...
    <li class="breadcrumb-item active mt-5" aria-current="page">Casa para vender</li>
  </ol>
</nav>
    ...
    <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="public/assets/images/terreno-itanhaem.jpg" class="d-block w-100" alt="Primeira Imagem">
        </div>
        <div class="carousel-item">
          <img src="public/assets/images/terreno-itanhaem.jpg" class="d-block w-100" alt="Segunda Imagem">
        </div>
      </div>
...
<div class="container">
  <div class="row">
    ...
    <div class="lc-block">
      <div editable="rich">
        <h1 class="text-center">Terreno em Itanhaém</h1>
        <div class="price mb-2">
          <i class="bi bi-tag-fill m-2" style="color: #08283B;"></i><span style="color: #08283B">R$230.000,00</span>
        </div>
        <div class="price mb-2">
          <i class="ri-fullscreen-line m-2" style="color: #08283B;"></i><span style="color: #08283B">300 m²</span>
        </div>
