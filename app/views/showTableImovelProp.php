...
<head>
<meta charset="UTF-8">
<title> Imóveis - Listar Imóveis</title>
...
function showTable() {
    ...
    foreach ( $rows as $row ){
        echo "<form class='frmLine' id='frmLine".$row['idip']."'>";
        echo
        "<tr>
            <td><input class='form-control linha' type='text' name='idip' value='".$row['idip']."' readonly ></td>
            ...
            <td><input class='form-control linha' type='text' name='sobrenome'     value='".$row['sobrenome']."'  ></td>
             <td><input class='form-control linha' type='email' name='sobrenome'     value='".$row['email']."'  ></td>
             <td><input class='form-control linha' type='text' name='cpf'     value='".$row['cpf']."'  ></td>
             <td><input class='form-control linha' type='email' name='pretende'     value='".$row['pretende']."'  ></td>
             <td><input class='form-control linha' type='text' name='valorvenda'     value='".$row['valorvenda']."'  ></td>
  <td><input class='form-control linha' type='text' name='valorlocacao'     value='".$row['valorlocacao']."'  ></td>
 <td><input class='form-control linha' type='text' name='tipo'     value='".$row['tipo']."'  ></td>
  <td><input class='form-control linha' type='text' name='finalidade'     value='".$row['finalidade']."'  ></td>
  <td><input class='form-control linha' type='text' name='cep'     value='".$row['cep']."'  ></td>
 <td><input class='form-control linha' type='text' name='cidade'     value='".$row['cidade']."'  ></td>
  <td><input class='form-control linha' type='text' name='estado'     value='".$row['estado']."'  ></td>
 <td><input class='form-control linha' type='text' name='logradouro'     value='".$row['logradouro']."'  ></td>
  <td><input class='form-control linha' type='text' name='bairro'     value='".$row['bairro']."'  ></td>
 <td><input class='form-control linha' type='text' name='maisinformacoes'     value='".$row['maisinformacoes']."'  ></td>
  <td><input class='form-control linha' type='text' name='image'     value='".$row['imagem']."'  ></td>        
 <td><input class='form-control linha' type='text' name='status_aluguel'     value='".$row['status_aluguel']."'  ></td>
  <td><input class='form-control linha' type='text' name='status_compra'     value='".$row['status_compra']."'  ></td>             
