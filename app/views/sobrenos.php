...
<body>
  ...
  <ol class="breadcrumb mt-4">
	...
	<div class="container mt-4">
		<div class="row mb-3">
			<div class="col-md-4">
				<div class="p-lg-5 p-4 mt-2 shadow" id="card">
					<div class="mb-3 mt-2">
						<p>
							...
							compra, venda ou aluguel de imóveis uma experiência tranquila.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="p-lg-5 p-4 mt-2 shadow" id="card">
					<div class="mb-3 mt-2">
						...
						Buscamos a excelência, desde o atendimento ao cliente até a gestão de propriedades e marketing imobiliário
							 <span
								style="color: black; font-weight: bold;">Compromisso com o cliente:</span> Colocamos os interesses, a transparência e necessidades de nossos clientes em primeiro lugar, oferecendo soluções personalizadas e superando suas expectativas.
						</p>
					</div>
				</div>
			</div>
