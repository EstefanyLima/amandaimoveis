...
<div class="row justify-content-center align-items-center">
    ...
    <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="public/assets/images/bambi1.jpg" class="d-block w-100" alt="Primeira Imagem">
        </div>
        <div class="carousel-item">
          <img src="public/assets/images/bambi2.jpg" class="d-block w-100" alt="Segunda Imagem">
        </div>
  ...
  <div class="row">
    ...
    <div class="lc-block">
      <div editable="rich">
        <h1 class="text-center">Casa para alugar no Bambi</h1>
        <div class="price mb-2">
          <i class="bi bi-tag-fill m-2" style="color: #08283B;"></i><span style="color: #08283B">R$700,00</span>
        </div>
        <div class="price mb-2">
          <i class="ri-fullscreen-line m-2" style="color: #08283B;"></i><span style="color: #08283B">280 m²</span>
        </div>
                <div class="price mb-2">
          <i class="fa fa-bath m-2" style="color: #08283B;"></i><span style="color: #08283B">1</span>
        </div>
