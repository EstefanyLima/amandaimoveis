  ...
  <div class="container-fluid">
   <img class=" navbar-brand img" src="public/assets/images/imglogo.png">
	...
	<!-- fim modal login -->
        ...
        <div class="col py-3">
            <h3 class="text-center">Delete e Update de Proprietários</h3>
            <?php
use models\Proprietario;
function showTable() {
    $proprietario = new Proprietario();
    $rows = $proprietario->listAll();
    echo "<table>";
    echo "
    ...
    foreach ( $rows as $row ){
        echo "<form class='frmLine' id='frmLine".$row['idproprietario']."'>";
        echo
        "<tr>
            <td><input class='form-control linha' type='text' name='idProprietario' value='".$row['idproprietario']."' readonly ></td>
            ...
            <td><input class='form-control linha' type='text' name='endereco'      value='".$row['endereco']."'  ></td>
            <td><input class='form-control linha' type='text' name='telefone'     value='".$row['telefone']."'  ></td>
            <td><input class='form-control linha' type='text' name='nacionalidade'  value='".$row['nacionalidade']."'  ></td>
            <td><input class='form-control linha'type='date' name='nascimento'  value='".$row['nascimento']."'  ></td>
