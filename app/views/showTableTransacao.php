...
<head>
<meta charset="UTF-8">
<title>Amanda Imóveis - Listar contatos</title>
...
function showTable() {
    ...
    foreach ( $rows as $row ){
        ...
        "<tr>
            ...
            <td><input class='form-control' type='text' name='idimovel'  value='".$row['idimovel']."'  ></td>
            <td><input class='form-control' type='text' name='cliente_id'     value='".$row['cliente_id']."'  ></td>
           <td><input class='form-control' type='text' name='tipo_transacao'  value='".$row['tipo_transacao']."'  ></td>
            <td><input class='form-control' type='date' name='data_transacao'  value='".$row['data_transacao']."'  ></td>
            <td><input class='form-control'type='number' name='valor_transacao'  value='".$row['valor_transacao']."'  ></td>
