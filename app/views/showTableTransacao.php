...
<head>
<meta charset="UTF-8">
<title> Imóveis - Listar contatos</title>
  ...
  <div class="container-fluid">
   <img class=" navbar-brand img" src="public/assets/images/imglogo.png">
	...
	<!-- fim modal login -->
        ...
        <div class="col py-3">
            <h3 class="text-center">Delete e Update de Transações</h3>

            <?php
use models\Transacao;
function showTable() {
    $transacao = new Transacao();
    $rows = $transacao->listAll();
    ...
    foreach ( $rows as $row ){
        ...
        "<tr>
            <td><input class='form-control linha' type='text' name='Id' value='".$row['id']."' readonly ></td>
            <td><input class='form-control linha' type='text' name='idimovel'  value='".$row['idimovel']."'  ></td>
            <td><input class='form-control linha' type='text' name='cliente_id'     value='".$row['cliente_id']."'  ></td>
           <td><input class='form-control linha' type='text' name='tipo_transacao'  value='".$row['tipo_transacao']."'  ></td>
            <td><input class='form-control linha' type='date' name='data_transacao'  value='".$row['data_transacao']."'  ></td>
            <td><input class='form-control linha'type='number' name='valor_transacao'  value='".$row['valor_transacao']."'  ></td>
