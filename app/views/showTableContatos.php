      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="dropdown-item text-dark" href="showTransacao">Transação</a></li>
             <li><a class="dropdown-item text-dark" href="showFuncionarios">Funcionários</a></li>
              <li><a class="dropdown-item text-dark" href="#">Contatos</a></li>
...
function showTable() {
    ...
    foreach ( $rows as $row ){
        ...
        "<tr>
            <td><input class='form-control' type='text' name='idContato' value='".$row['IdContato']."' readonly ></td>
            ...
            <td><input class='form-control'type='text' name='mensagem'  value='".$row['mensagem']."'  ></td>
