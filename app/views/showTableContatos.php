  ...
  <div class="container-fluid">
   <img class=" navbar-brand img" src="public/assets/images/imglogo.png">
	...
	<!-- fim modal login -->
        ...
        <div class="col py-3">
            <h3 class="text-center">Delete e Update de Contatos</h3>
            <?php
use models\Contato;
function showTable() {
    $contato = new Contato();
    $rows = $contato->listAll();
    ...
    foreach ( $rows as $row ){
        echo "<form class='frmLine' id='frmLine".$row['IdContato']."'>";
        echo
        
        "<tr>
            <td><input class='form-control linha' type='text' name='idContato' value='".$row['IdContato']."' readonly ></td>
            <td><input class='form-control linha' type='text' name='nome'      value='".$row['nome']."'  ></td>
            <td><input class='form-control linha' type='text' name='email'     value='".$row['email']."'  ></td>
            <td><input class='form-control linha' type='text' name='telefone'  value='".$row['telefone']."'  ></td>
            <td><input class='form-control linha'type='text' name='mensagem'  value='".$row['mensagem']."'  ></td>
